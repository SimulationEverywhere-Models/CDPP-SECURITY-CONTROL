...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  DoorLatch.o PinReader.o cpu1.o cpu2.o register.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#
...
#^|
DoorLatch.o: /cygdrive/C/eclipse/workspace/1-TRAVAIL/securityctl/DoorLatch.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
PinReader.o: /cygdrive/C/eclipse/workspace/1-TRAVAIL/securityctl/PinReader.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
cpu1.o: /cygdrive/C/eclipse/workspace/1-TRAVAIL/securityctl/cpu1.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
cpu2.o: /cygdrive/C/eclipse/workspace/1-TRAVAIL/securityctl/cpu2.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/eclipse/workspace/1-TRAVAIL/securityctl/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
DoorLatch.o: \
 /cygdrive/C/eclipse/workspace/1-TRAVAIL/securityctl/DoorLatch.cpp \
 /cygdrive/C/eclipse/workspace/1-TRAVAIL/securityctl/DoorLatch.h \
...
PinReader.o: \
 /cygdrive/C/eclipse/workspace/1-TRAVAIL/securityctl/PinReader.cpp \
 /cygdrive/C/eclipse/workspace/1-TRAVAIL/securityctl/PinReader.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
cpu1.o: /cygdrive/C/eclipse/workspace/1-TRAVAIL/securityctl/cpu1.cpp \
 /cygdrive/C/eclipse/workspace/1-TRAVAIL/securityctl/cpu1.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
cpu2.o: /cygdrive/C/eclipse/workspace/1-TRAVAIL/securityctl/cpu2.cpp \
 /cygdrive/C/eclipse/workspace/1-TRAVAIL/securityctl/cpu2.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
register.o: \
 /cygdrive/C/eclipse/workspace/1-TRAVAIL/securityctl/register.cpp \
